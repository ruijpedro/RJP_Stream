...
for(const needle of ["APP_VERSION = '1.2.0'",'parseM3U','driveSync','openPlayer','epgForItem','toggleVpn','driveSyncBridge','historyUpsert','recentHistoryItems','epgModal','RJP Stream']){
...
console.log('Smoke test RJP Stream V1.1 OK');
