...
for(const needle of ["APP_VERSION = '1.5.0'",'parseM3U','driveSync','openPlayer','epgForItem','toggleVpn','driveSyncBridge','historyUpsert','recentHistoryItems','epgModal','playlistPreviewModal','loadRemoteCatalog','manageRemoteSource','scanWebProvider','extractSiteGames','extractSiteCatalog','webCatalogItems','providerCatalogModal','combinedFootballGames','RJP Stream']){
...
console.log('Smoke test RJP Stream V1.5 OK');
