...
gradle=gradle.replace(/versionCode\s+\d+/, 'versionCode 10500');
gradle=gradle.replace(/versionName\s+["'][^"']+["']/, 'versionName "1.5.0"');
    ...
    public void request(PluginCall call) {
        ...
        new Thread(() -> {
            ...
            try {
                ...
                conn.setRequestProperty("User-Agent", "RJPStream/1.5.0 Android");
...
console.log('RJP Stream V1.5 Android preparado: telemóvel/tablet/TV + IconKitchen + banner + WireGuard + HTTP nativos.');
